...
function ventanaSecundaria (URL){ 
	window.open(URL,"ventana1","width=400,height=400,left=500,scrollbars=NO") 
 } 
     ...
     $.ajax({
     	...
     	url:"ajax/productos.ajax.php",
      	...
      	success:function(respuesta){
          	...
          	'<div class="row col-sm-12"  style="padding:5px 15px">'+
	          ...
	          '<div class="col-sm-6" style="padding-right:0px">'+
	            ...
	            '<div class="input-group">'+
	              ...
	              '<span class="input-group-addon"><button type="button" class="btn btn-danger btn-link quitarProducto" idProducto="'+idProducto+'"><i class="fa fa-times"></i></button></span>'+
	          ...
	          '<div class="col-sm-2">'+
	             ...
	             '<input type="number" class="form-control nuevaCantidadProducto" name="nuevaCantidadProducto" min="1" value="1" stock="'+stock+'" nuevoStock="'+Number(stock-1)+'" required style="width:60px;">'+
...
$("#nuevoMetodoPago").change(function(){
	...
	if(metodo == "Efectivo"){
		...
		$(this).parent().parent().parent().children(".cajasMetodoPago").html(
			...
			'</div>'+
		'</div>'+
		'<div class="col-md-12" id="capturarCambioEfectivo" style="padding-left:0px">'+
			'<div class="input-group">'+
				'<span class="input-group-addon"><i class="ion ion-social-usd"></i></span>'+
	...
	for(var i = 0; i < idProductos.length; i++){
		...
		for(var j = 0; j < botonesTabla.length; j ++){
			...
			if($(botonesTabla[j]).attr("idProducto") == boton){
				...
				$(botonesTabla[j]).removeClass("btn-default agregarProducto");
				$(botonesTabla[j]).addClass("btn-success");
